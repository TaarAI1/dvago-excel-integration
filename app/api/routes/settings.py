...
async def save_settings(body: SettingsUpdateRequest, _: str = Depends(get_current_user)):
    ...
    scheduler_keys = {
        "poll_cron_schedule", "sales_export_cron", "sales_export_cron_2",
        "digest_email_interval_hours", "digest_email_interval_hours_2", "digest_email_interval_hours_3",
        "digest_email_recipients_1", "digest_email_recipients_2", "digest_email_recipients_3",
        "duplication_email_interval_hours",
    }
