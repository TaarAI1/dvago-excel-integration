...
class PriceAdjustmentDoc(Base):
    __tablename__ = "price_adjustment_docs"
    ...
    price_lvl_sid: Mapped[str | None] = mapped_column(String(255), nullable=True)
...
def price_adj_doc_to_response(doc: PriceAdjustmentDoc) -> dict:
    return {
        "id": str(doc.id),
        ...
        "adj_sid": doc.adj_sid,
        "note": doc.note,
        "price_lvl_sid": doc.price_lvl_sid,
